...
1. Gunakan Dynamic Table pada table hasil generate dbt model dan merujuk pada table raw agar data pada table selalu update mengikuti perubahan data yang terjadi pada table raw.
